...
async function loadSingleProduct() {
    ...
    if (parameters.has("pid")) {
        ...
        if (response.ok) {
            ...
            document.getElementById("product-category").innerHTML = product.model.category.name;
            document.getElementById("product-brand").innerHTML = product.brand.name;
            ...
            document.getElementById("add-to-cart").addEventListener("click", (e) => {
                addToCart(json.product.id, document.getElementById("sst").value);
                e.preventDefault();
            });
